...
Cilj projekta je da se ispita na koji način fizički zakoni i biomehanički faktori utiču na izvođenje pokreta, rotaciju, ravnotežu i stabilnost sportista tokom okreta. Baletske igračice i umetničke klizačice analiziraju se na osnovu video-snimaka i biomehaničkih modela, čime se omogućava kvantitativno poređenje njihovih karakteristika kretanja.

Analiza obuhvata parametre kao što su ugaoni pomeraj, ugaona brzina, centar mase (CoM), ugao nagiba tela, efektivna dužina klatna, ekstrapolisani centar mase (XCoM) i margina stabilnosti (MoS). Projekat povezuje principe rotacione dinamike, mehanike i biomehanike čoveka kako bi se utvrdile razlike između ove dve discipline.

Podaci o kretanju izdvajaju se iz video-snimaka primenom metoda računarskog vida i procene položaja tela. Antropometrijski parametri uključeni su u biomehanički model kako bi se dobile realističnije procene položaja centra mase i karakteristika stabilnosti izvođača.

Cilj je da se utvrdi kako različito fizičko okruženje i tehnika klasičnog baleta i umetničkog klizanja utiču na rotaciono kretanje i dinamičku ravnotežu, kao i da se ispita da li se isti fizički principi mogu primeniti na opisivanje oba tipa kretanja.
